...
LP.createPharmacyGoodsReceipt(danpheEMR=EMR, supplier=GSV.pharmacySupplierName1, DrugName=Drug1, itemQty=Qty1, freeQty=0, grPrice=Drug1Price, Margin=0, cc=0, discountPer=0, vatPer=0, NepaliReceipt=NepaliReceipt)