...
LADT.admitDisTrans(danpheEMR=EMR, admit=1, discharge=0, transfer=0, deposit=0, HospitalNo=HospitalNo, department=GSV.departmentGyno, doctor=GSV.doctorGyno, admittingDoctorMandatory=isDoctorMandatory)
LB.createIPprovisionalBill(danpheEMR=EMR, HospitalNo=HospitalNo, usgtest=USG)
