...
ADT.admitDisTrans(danpheEMR=EMR, admit=0, discharge=0, trasfer=1, deposit=deposit, HospitalNo=HospitalNo, department=GSV.departmentGyno, doctor=GSV.doctorGyno, admittingDoctorMandatory=isDoctorMandatory)
print("Patient Transferred successfully")
ADT.admitDisTrans(danpheEMR=EMR, admit=0, discharge=1, trasfer=0, deposit=deposit, HospitalNo=HospitalNo, department=GSV.doctorGyno, doctor=GSV.doctorGyno, admittingDoctorMandatory=isDoctorMandatory)
