...
def admitDisTrans(danpheEMR, admit, discharge, trasfer,HospitalNo, deposit, doctor, department):
      if admit == 1:
         if AppName == "SNCH" or AppName == "MPH" or AppName == "LPH":
            ...
            #danpheEMR.find_element(By.ID, "WardId").send_keys(Keys.DOWN)
            ...
            if AppName == "LPH":
                ...
                #danpheEMR.find_element(By.ID, "btnPrintRecipt").send_key(Keys.ESCAPE)
            elif AppName == "MPH":
                danpheEMR.find_element(By.ID, "btnAdtSticker").click()
                #danpheEMR.find_element(By.ID, "btnAdtSticker").send_keys(Keys.ESCAPE)
            else:
                danpheEMR.find_element(By.XPATH,  "//button[@class='btn btn-danger' and contains(text(),'X')]").click()
         ...
         # danpheEMR.find_element(By.ID, "btnPrintDischargeInvoice")
         ...
         danpheEMR.find_element(By.ID, "WardId").send_keys(Keys.ENTER)
         # time.sleep(1)
         # WardID = Select(danpheEMR.find_element(By.ID, 'WardId').send_keys(Keys.ENTER))
         ...
         # Bedfeature = Select(danpheEMR.find_element(By.ID, "BedFeatureId"))
         # Bedfeature.select_by_visible_text("BED CHARGE ICU")
         danpheEMR.find_element(By.ID, "BedId").click()
         danpheEMR.find_element(By.ID, "BedId").send_keys(Keys.ARROW_DOWN)
         danpheEMR.find_element(By.ID, "BedId").send_keys(Keys.ENTER)
         # danpheEMR.find_element(By.XPATH,  "//select").send_keys(Keys.RETURN)
         # danpheEMR.find_element(By.XPATH,  "//select").send_keys(Keys.ARROW_DOWN)
         # danpheEMR.find_element(By.XPATH,  "//select").send_keys(Keys.ARROW_DOWN)
         # danpheEMR.find_element(By.XPATH,  "//select").send_keys(Keys.ARROW_DOWN)
         # danpheEMR.find_element(By.XPATH,  "//select").send_keys(Keys.RETURN)
         # danpheEMR.find_element(By.XPATH,  "//tr[5]/td[2]/select").send_keys(Keys.RETURN)
         # danpheEMR.find_element(By.XPATH,  "//tr[5]/td[2]/select").send_keys(Keys.ARROW_DOWN)
         # danpheEMR.find_element(By.XPATH,  "//tr[5]/td[2]/select").send_keys(Keys.RETURN)
         # danpheEMR.find_element(By.XPATH,  "//tr[7]/td[2]/select").send_keys(Keys.RETURN)
         # danpheEMR.find_element(By.XPATH,  "//tr[7]/td[2]/select").send_keys(Keys.ARROW_DOWN)
         # danpheEMR.find_element(By.XPATH,  "//tr[7]/td[2]/select").send_keys(Keys.RETURN)
