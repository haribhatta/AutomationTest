...
from AutomationTest.Library.GlobalShareVariables import GSV
...
class A:
   ...
   #appURL = "Test URL"
   #appPort = "0"
   #print("This is for test of appPort", appPort)
   ...
   def logout(self):
      ...
      print("LogOut: END<<")
   # Module:Appointment --------------------
   def patientquickentry(self, discountpc, paymentmode, department):
      ...
      if appPort == "82":
         ...
         self.danpheEMR.find_element_by_id("txtDepartment").send_keys(department)
