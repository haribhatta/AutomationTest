...
pharmacyTestCases = "excelTestCasesTestPackPharmacyReports_"
pharmacyTestCasesResult = "excelResultTestPackPharmacyReports_"
...
if scheduletype == '1':
    Originalfile = pharmacyTestCases + AppName + ".xlsx"

elif scheduletype == '2':
    Originalfile = pharmacyTestCasesResult + AppName + appVersion + ".xlsx"
    print("Originalfile:", Originalfile)

duplicatefile = pharmacyTestCasesResult + AppName + appVersion + ".xlsx"
