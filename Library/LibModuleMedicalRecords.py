...
def addMRwithDischargeTypeDeath(danpheEMR, HospitalNo):
   ...
   if  AppName == "SNCH" or AppName == "MPH" or AppName == "LPH":
      ...
      time.sleep(3)
      dischargeType = Select(danpheEMR.find_element(By.XPATH, "(//select)[2]"))
      time.sleep(3)
      dischargeType.select_by_visible_text("Death")
      time.sleep(3)
      dischargeCondition = Select(danpheEMR.find_element(By.XPATH, "(//select)[3]"))
      dischargeCondition.select_by_visible_text('Post Operative Death')
      time.sleep(3)
      deathPeriod = Select(danpheEMR.find_element(By.XPATH, "(//select)[4]"))
      time.sleep(1)
