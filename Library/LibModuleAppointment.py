...
def patientquickentry(danpheEMR, discountScheme, paymentmode, department, doctor, priceCategoryType):
    ...
    if AppName == "SNCH" or AppName == "MPH" or AppName == "LPH":
        ...
        if discountScheme != 0 and AppName == "LPH":
            ...
            dropdown.find_element(By.XPATH, "//option[. = 'Child Under Nutrition (50%)']").click()
            danpheEMR.find_element(By.ID, "Scheme").click()
            dropdown = danpheEMR.find_element(By.ID, "Scheme")
            dropdown.find_element(By.XPATH, "//option[. = 'Covid Free (100%)']").click()
            danpheEMR.find_element(By.ID, "Scheme").click()
            dropdown = danpheEMR.find_element(By.ID, "Scheme")
            dropdown.find_element(By.XPATH, "//option[. = 'OCMC (100%)']").click()
            # dropdown.find_element(By.XPATH, "//option[. = 'Helpless (50%)']").click()
        elif discountScheme != 0 and AppName == ("MPH" or "SNCH"):
