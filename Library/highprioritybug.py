...
systemTestFile = "HighPriorityBugExcel/excelTestCasesTestPackBUGS"
systemTestResult = "HighPriorityBugExcel/excelResultHighPriorityBug"
...
if scheduleType == '1':
    Originalfile = systemTestFile + ".xlsx"
...
def files(file, file1, rows, *args):
    ...
    for r in range(2, rows + 1):
        ...
        if Status == 'Norun' or Status == 'UnderAnalysis':
            ...
            base_dir = str(pathlib.PureWindowsPath(LSV.BugsPath))
